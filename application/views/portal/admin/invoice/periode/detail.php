    ...
    <div class="container mt-5 mb-5">
        <div class="toolbar hidden-print">
            <div class="text-right">
                <?php $date_invoice = date_format(date_create($this->uri->segment(4)), "M Y") ?>
                <?php $link = site_url() . "portal/invoice/periode/" . $this->uri->segment(4) . "/" . $this->uri->segment(5) ?>
                ...
                <h5>
                    ...
                    <span class="ml-3">
                        <?php if (substr($this->session->userdata('id'), 0, 1) == "3") : ?>
                            <a href="<?= site_url() ?>portal/C_Admin/add_other_invoice/<?= $ortu[0]['id_parent'] ?>/<?= $this->uri->segment(4) ?>" class="btn btn-primary btn-sm">

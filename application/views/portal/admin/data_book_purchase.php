...
<main class="page-content">
    <div class="container-fluid">
        <h2 style="font-weight:bold">Data Book Purchase</h2>
        <hr>
        <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-lg-12 pt-3">
                ...
                |
                <a href="<?= site_url() ?>portal/book/sell" class="btn ml-1 pl-4 pr-4" style="background-color:#f1f3f8; font-size:12px">
                    Sell
                </a>

            </div>
            <div class="col-lg-12 text-lg-right pt-lg-1 pt-3">
                <a href="<?= site_url() ?>portal/book/input/add" class="btn btn-primary mr-3">
...
<script>
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= site_url('portal/C_Admin/get_ajax_book_purchase') ?>",
                "type": "POST"
            },
            'columnDefs': [{

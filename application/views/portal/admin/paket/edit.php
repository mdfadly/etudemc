...
<script>
    $(document).ready(function() {
        $('.select-form').select2();
        console.log(formatRupiah(String(<?= $paket[0]['price_idr'] ?>)));
        document.getElementById("price_idr_rupiah").value = formatRupiah(String(<?= $paket[0]['price_idr'] ?>));
        document.getElementById("duration").value = '<?= $paket[0]['duration'] ?>';
        document.getElementById("description").value = '<?= $paket[0]['description'] ?>';

    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pt-3">
                ...
                |
                <a href="<?= site_url() ?>portal/invoice/online" class="btn ml-1 mr-1 pl-4 pr-4 btn-light">
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($invoice_temp); $i++) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url(); ?>portal/invoice/summary/offline/<?= $invoice_temp[$i] ?>" class="btn btn-info">
                                            View
                                        </a>
                                    </td>
                                </tr>

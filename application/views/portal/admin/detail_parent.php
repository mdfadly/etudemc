    ...
    <div class="container-fluid">
        <div style="text-align:left;">
            ...
            <span style="float:right;">
                <a href="<?= site_url() ?>portal/C_Admin/delete_data_parent/<?= $student[0]['id_parent'] ?>" class="btn btn-danger" title="Hapus Data Ini" onclick='return confirm("this data will be deleted. are you sure?")'>

<main class="page-content">
    <div class="container-fluid">
        ...
        <hr>
        <form action="<?= site_url('portal/C_Teacher/add_data_note'); ?>" method="POST">
            <div class="row">
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-12 col-12 justify-content-center">
                    ...
                    <textarea class="form-control" rows="15" name="keterangan" placeholder="Input note here.."></textarea>
                </div>
            </div>
        </form>
    </div>

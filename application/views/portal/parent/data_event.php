    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pt-3">
                ...
                |
                <a href="<?= site_url() ?>portal/join-event/student" class="btn ml-1 pl-4 pr-4" style="background-color:#f1f3f8; font-size:12px">
                    Student Register
                </a>
            </div>
...
<script>
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url('portal/C_Parent/get_ajax_event') ?>",
                "type": "POST"
            },
            'columnDefs': [{

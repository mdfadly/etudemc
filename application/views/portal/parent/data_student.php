    ...
    <div class="container-fluid">
        <div style="text-align:left;">
            ...
            <span style="float:right;">
                <a href="<?= site_url() ?>portal/profile-parent/student/edit/<?= $student[0]['id_student'] ?>" class="btn btn-primary">
                    <i class="fa fa-edit icon-white"></i>
                </a>
                <a href="<?= site_url() ?>portal/C_Parent/delete_data_student/<?= $student[0]['id_student'] ?>" class="btn btn-danger" title="Hapus Data Ini" onclick='return confirm("this data will be deleted. are you sure?")'>
                ...
                <?php foreach ($student as $s) : ?>
                    <div class="form-group text-center">
                        <div class="cover-img" id="divImg_student">
                            <img src="<?= base_url() ?>assets/img/pict_student/<?= $s['pict_student'] ?>" class="avatar rounded-circle img-thumbnail" alt="avatar">
                        </div>
                    </div>

    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pt-3">
                <a href="<?= site_url() ?>portal/order-book" class="btn ml-1 mr-1 pl-4 pr-4" style="background-color:#f1f3f8; font-size:12px">
                    Stock
                </a>
                |
...
<script>
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= site_url('portal/C_Parent/get_ajax_book_order') ?>",
                "type": "POST"
            },
            'columnDefs': [{

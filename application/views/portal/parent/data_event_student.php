    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 pt-3">
                <a href="<?= site_url() ?>portal/join-event" class="btn ml-1 pl-4 pr-4" style="background-color:#f1f3f8; font-size:12px">
                    Event List
                </a>
                |
            ...
            <div class="col-lg-12 text-lg-right pt-lg-1 pt-3">
                <a href="<?= site_url() ?>portal/join-event/student/regist" class="btn btn-primary mr-3">
                    Register
                </a>
            </div>
...
<script>
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= site_url('portal/C_Parent/get_ajax_event_student') ?>",
                "type": "POST"
            },
            'columnDefs': [{
